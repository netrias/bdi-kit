...
SCHEMA_PATH = join(dirname(__file__), "../resource/sage_ImagingAssayTemplate_schema.json")

class ImagingAssayTemplate(BaseStandard):
    """
    Class for sage_ImagingAssayTemplate_schema standard.
    """
