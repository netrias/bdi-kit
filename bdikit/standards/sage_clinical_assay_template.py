...
SCHEMA_PATH = join(dirname(__file__), "../resource/sage_ClinicalAssayTemplate_schema.json")

class ClinicalAssayTemplate(BaseStandard):
    """
    Class for sage_ClinicalAssayTemplate_schema standard.
    """
