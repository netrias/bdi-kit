...
GC_SCHEMA_PATH = join(dirname(__file__), "../resource/gc_schema.json")

class GC(BaseStandard):
    """
    Class for GC standard.
    """
    ...
    def __read_data(self):
        with open(GC_SCHEMA_PATH) as json_file:
