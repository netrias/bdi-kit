...
SCHEMA_PATH = join(dirname(__file__), "../resource/sage_RNASeqTemplate_schema.json")

class SageRNASeqTemplate(BaseStandard):
    """
    Class for sage_RNASeqTemplate_schema standard.
    """
