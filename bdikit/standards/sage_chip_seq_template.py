...
SCHEMA_PATH = join(dirname(__file__), "../resource/sage_ChIPSeqTemplate_schema.json")

class ChIPSeqTemplate(BaseStandard):
    """
    Class for sage_ChIPSeqTemplate_schema standard.
    """
